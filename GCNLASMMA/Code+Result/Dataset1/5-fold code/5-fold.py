...
for count in range(100):
    ...
    for y in range(5):
        A = AA.copy()
        array1 = array[0 + y * math.floor(132):math.floor(132) * (y + 1)]
        for z1 in array1:
            A[B[z1, 0] - 1, B[z1, 1] - 1] = 0
        if y == 4:
            array1 = array[4 * math.floor(132):664]
            for z1 in array1:
                A[B[z1, 0] - 1, B[z1, 1] - 1] = 0
...
#Output the rank
            ...
            list3.append('\t')
            Global = open('../5-fold result/5_fold.txt','a+')
